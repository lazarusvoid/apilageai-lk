<?php
/* Smarty version 5.6.0, created on 2025-11-27 15:27:30
  from 'file:index.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.6.0',
  'unifunc' => 'content_6928208a06a074_50567680',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd6386a5e7d21374c7dca75e1492054780f8c412c' => 
    array (
      0 => 'index.tpl',
      1 => 1764237446,
      2 => 'file',
...
function content_6928208a06a074_50567680 (\Smarty\Template $_smarty_tpl) {
...
?>
      ...
      <section class="py-8 border-y-2 border-brand-dark bg-brand-dark text-white overflow-hidden">
        <div class="flex whitespace-nowrap gap-16 animate-marquee" style="width: calc(200% + 4rem);">
          <span class="text-3xl font-black font-display tracking-widest text-brand-blueLight">APILAGE AI</span>
          <span class="text-3xl font-black font-display tracking-widest text-brand-blueLight">NATIVE PLATFORM</span>
          <span class="text-3xl font-black font-display tracking-widest text-brand-blueLight">MINDMAPS</span>
          <span class="text-3xl font-black font-display tracking-widest text-brand-blueLight">FLOWCHARTS</span>
          <span class="text-3xl font-black font-display tracking-widest text-brand-blueLight">IMAGE GEN</span>
          <span class="text-3xl font-black font-display tracking-widest text-brand-blueLight">APILAGE AI</span>
          <span class="text-3xl font-black font-display tracking-widest text-brand-blueLight">SRI LANKA</span>
      ...
      <section id="features" class="py-24 relative overflow-hidden bg-white">
        <div class="container mx-auto px-6">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            <div class="flip-card bg-white rounded-xl border-2 border-brand-dark shadow-hard hover:shadow-hard-lg transition-all duration-300">
              <div class="flip-card-inner">
                <div class="flip-card-front p-6">
                  <div class="w-14 h-14 bg-brand-blueLight border-2 border-brand-dark rounded-lg flex items-center justify-center mb-4 transition-colors">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-brand-dark">
                      ...
                      <polyline points="7.5,4.27 16.5,9.27"/>
                      <polyline points="7.5,9.27 7.5,14.73"/>
                      <polyline points="16.5,9.27 16.5,14.73"/>
                      <polyline points="12,16.73 12,21.73"/>
                      <polyline points="12,9.27 12,14.73"/>
                    </svg>
                  </div>
            ...
            <div class="flip-card bg-white rounded-xl border-2 border-brand-dark shadow-hard hover:shadow-hard-lg transition-all duration-300">
              <div class="flip-card-inner">
                <div class="flip-card-front p-6">
                  ...
                  <p class="text-brand-dark/70 text-sm font-medium">Convert processes and history timelines into clear flowcharts.</p>
                </div>
                <div class="flip-card-back p-6">
                  <video class="w-full h-full object-cover rounded-lg" muted loop playsinline preload="metadata">
